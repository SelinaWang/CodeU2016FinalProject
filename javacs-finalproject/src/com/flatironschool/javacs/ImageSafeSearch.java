...
public class ImageSafeSearch {
  /**
   * Be sure to specify the name of your application. If the application name is {@code null} or
   * blank, the application will log a warning. Suggested format is "MyCompany-ProductName/1.0".
   */
  private static final String APPLICATION_NAME = "team-22-codeu-project/1.0";
  ...
  public static void main(String[] args) throws IOException, GeneralSecurityException {
    if (args.length != 1) {
      ...
      System.err.printf("\tjava %s gs://<bucket_name>/<object_name>\n",
          ImageSafeSearch.class.getCanonicalName());
      System.exit(1);
    ...
    ImageSafeSearch app = new ImageSafeSearch(getVisionService());
  ...
  /**
   * Constructs a {@link ImageSafeSearch} which connects to the Vision API.
   */
  public ImageSafeSearch(Vision vision) {
    this.vision = vision;
  }
   ...
   */
  public List<EntityAnnotation> identifyNSFW(String uri, int maxResults) throws IOException {
